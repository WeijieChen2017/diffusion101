...
default_project_name = "cv0_EncTrue_DecFalse_epochs600_LossMAE_seed729_x128_y128_z128"
...
def main():
    ...
    # This is the old version which only save the weights, but now we save everything
    # autoencoder = download_and_reload_ckpt()
