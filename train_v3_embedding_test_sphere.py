...
from train_v3_embedding_utils import prepare_dataset, printlog, test_diffusion_model_unit_sphere_and_save_slices
...
test_diffusion_model_unit_sphere_and_save_slices(
